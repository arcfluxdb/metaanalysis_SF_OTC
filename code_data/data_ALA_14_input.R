...
AK_C <- read_excel("D:/flux_db/Working_folder/3_third round_2023/Korea/NEE_data_import_external_AK_Council_2023.xlsx", 
...
flux_data$site_id_automatic <- "ALA_14"
#### Plot_data 
plot_data <- suppressMessages(read_excel("D:/flux_db/Working_folder/3_third round_2023/Korea/NEE_data_import_external_AK_Council_2023.xlsx",
...
site_data <- suppressMessages(read_excel("D:/flux_db/Working_folder/3_third round_2023/Korea/NEE_data_import_external_AK_Council_2023.xlsx",
...
method_data <- suppressMessages(read_excel("D:/flux_db/Working_folder/3_third round_2023/Korea/NEE_data_import_external_AK_Council_2023.xlsx",
                                           sheet = "3_METHOD"))
...
co2_method$Site_Flux_ID <- "ALA_14_2023_ER"
ch4_method <- method_data[,-c(3:8)]
colnames(ch4_method) <- gsub("_2","",colnames(ch4_method))
ch4_method$Site_Flux_ID <- "ALA_14_2023_METH"

method_data <- rbind.fill(co2_method,
                          ch4_method)
method_data$site_id <- "ALA_14"

ALA_14 <- list()
ALA_14[["data"]] <- flux_data
ALA_14[["methods"]] <- method_data
ALA_14[["site"]] <- site_data

saveRDS(ALA_14,"database/ALA_14.rds")
