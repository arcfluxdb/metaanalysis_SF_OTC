...
map<-ggplot() +
  ...
  # Adds points
  geom_point(data=subset(unique_data, treatment != "CTL" & treatment != "OTC", ), aes(x=e_coord_site, y=n_coord_site,  
                           group=treatment, 
                           fill=treatment,
                           pch=treatment,
                           color=treatment),
             ...
             alpha=0.8,
             size=2)+  
  scale_fill_viridis_d(name = "treatment")+ # add color gradient
