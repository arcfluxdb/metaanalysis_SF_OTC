...
# cannot get site_id as y-axis...
sf_effect_sizes$site_id <- as.factor(sf_effect_sizes$site_id)
SF_na <- sf_effect_sizes[complete.cases(sf_effect_sizes$yi_sf), ]
library(orchaRd)
model_SF<-orchaRd::mod_results(SF_total, mod="site_id", data=SF_na)
orchard_plot(model_SF, mod = "year", group="year", 
...
library(orchaRd)
model_OTC<-orchaRd::mod_results(OTC_total, group="site_id", data=OTC_na)
orchard_plot(model_OTC, mod = "year", group="year", 
             xlab = "Ecosystem respiration", transfm = "none",data=otc_effect_sizes,
             trunk.size = 6)
# #GS
...
orchard_plot(model_OTC_SF, mod = "site_id", group="year", 
             xlab = "Ecosystem respiration", transfm = "none",data=otc_sf_effect_sizes,
             trunk.size = 6)
# #GS
